...
False
"""
print(t4ir['language']['python']['python standard library'] == 'requests')
...
매니저
"""
print(t4ir['classes']['bigdata']['lecturer'])
print(t4ir['classes']['bigdata']['manager'])
...
"""
for i,j in t4ir['language']['python']['frameworks'].items():
    print(i + "는 " + j + "이다.")
...
오늘의 당번은 황민승
"""
print("오늘의 당번은 " + random.choice((t4ir['classes']['connected']['groups']['E'])))
